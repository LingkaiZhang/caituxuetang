...
public class RookieCourseListActivity extends AbsLifecycleActivity<HomeViewModel> implements RefreshHelper.OnHelperRefreshListener, RefreshHelper.OnHelperLoadMoreListener, OnItemClickListener {
    ...
    private WeakReference<RookieCourseListActivity> weakReference;
    private ItemData mItems;
    private RefreshHelper refreshHelper;
    protected DelegateAdapter adapter;
    private Context activity = RookieCourseListActivity.this;
