package com.yuanin.fuliclub.view.bamtoast.btoast;
...
public class BToast extends Toast {
    ...
    public static BToast getToast(Context context, CharSequence text, int time,
        ...
        switch (iconType) {
            case ICONTYPE_SUCCEED:
                toast_img.setBackgroundResource(R.drawable.right);
    ...
    private static void initToast(Context context, CharSequence text) {
        try {
            ...
            // 由layout文件创建一个View对象
            layout = inflater.inflate(R.layout.toast_left_icon, null);

            // 吐司上的图片
            toast_img = layout.findViewById(R.id.toast_image);
